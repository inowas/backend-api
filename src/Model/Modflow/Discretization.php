...
final class Discretization extends ValueObject
{
    ...
    public static function fromParams(array $geometry, array $boundingBox, array $gridSize, array $cells, array $stressperiods, int $lengthUnit, int $timeUnit, ?float $intersection = 0.0, ?float $rotation = 0.0): Discretization
    {
        $self = new self();
